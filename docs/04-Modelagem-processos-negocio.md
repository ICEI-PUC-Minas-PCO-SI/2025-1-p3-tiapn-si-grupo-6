...
[Processo 1 – Cadastro de Produtos no Sistema]([docs/processes/processo-1-Cadastro_de_produtos_no_sistema.md](https://github.com/ICEI-PUC-Minas-PCO-SI/2025-1-p3-tiapn-si-grupo-6/blob/main/docs/processes/processo-1-Cadastro_de_produtos_no_sistema.md))
